...
const EditDiary = ({ onDiaryTextChange }) => {
  ...
  return (
    <WriteAreaBox>
      ...
      {/* <DetailsContainer>
        <span>
          아래사항을 추가적으로 적으면 더 정확하게 이미지를 구현할 수 있어요.
        </span>
        <Content
          value={location}
        ...
        <ToggleContent value={season} onChange={handleChange(setSeason)}>
        ...
        <ToggleContent value={weather} onChange={handleChange(setWeather)}>
          <option value="" disabled style={{ color: "grey" }}>
            날씨를 선택하세요.
          </option>
