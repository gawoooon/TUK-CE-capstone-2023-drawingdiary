...
public class GenerateDiaryService {
    ...
    /* 완전 처음 생성할때 */
    /* generateDiary(DiaryRequestDTO diaryRequestDTO) */
    // 1. Diary 생성, Diary 객체 받아옴 --> [완료] Diary diary = diaryService.addDiary(diaryRequestDTO)
    ...
    /* 완료버튼으로 다이어리 수정했을때 */
    /* reGenerateDiary(Diary diary, diaryRequestDTO) */
